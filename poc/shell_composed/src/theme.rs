//! Copied from `poc/shell_chrome/src/theme.rs` verbatim (per this crate's task: "adapt theme.rs
//! into this crate too (copy, don't leave it depending cross-crate)"). See that crate for the
//! original doc comments/rationale — not repeated here beyond what's needed to keep this file
//! self-explanatory.
//!
//! Minimal placeholder implementation of the `Theme` struct described in
//! `docs/neovibe_architecture_summary.md` §4 ("统一视觉系统"). This is a throwaway
//! feasibility-probe palette, not a real design system.
